...
//   let j=i+1;
//   navItems[0].textContent=siteContent["nav"]["nav-item"+j];
...
topContent[1].querySelector('p').textContent=siteContent[ 'ana-içerik']['özellikler-içerik'];
topContent[2].querySelector('h4').textContent=siteContent[ 'ana-içerik']['hakkımızda-h4'];
topContent[3].querySelector('p').textContent=siteContent[ 'ana-içerik']['hakkımızda-içerik'];
...
contact[2].textContent=siteContent["iletisim"]["telefon"];
contact[3].textContent=siteContent["iletisim"]["email"];
